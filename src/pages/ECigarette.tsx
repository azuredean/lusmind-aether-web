...
export default function ECigarette() {
  return (
    <div className="min-h-screen bg-[#D1B893]">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-lg bg-[#0B102A]/80 border-b border-white/10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-[#353995] to-[#E6FE7F] rounded-full flex items-center justify-center text-white font-bold">
              L
            </div>
            <span className="text-white font-bold text-xl">LUSMIND</span>
          </Link>
      ...
      <section className="py-20 bg-[#D1B893]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-[#3A2A25] mb-8 leading-relaxed text-center">
      ...
      <footer className="bg-[#0B102A] text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="font-bold text-lg mb-4">LUSMIND</h3>
