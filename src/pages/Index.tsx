...
const FLAVORS = [
  ...
  { key: "keel-scout", name: "Double Apple Shisha", palette: ["#CFE8FF", "#E6FE7F", "#D8F3E1"], bottle: { from: "#EAF4FF", to: "#CFE8FF" }, notes: ["double apple", "shisha smooth", "rich"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #EEF6FF 100%)" },
