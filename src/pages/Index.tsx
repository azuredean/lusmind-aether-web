...
const FLAVORS = [
  ...
  { key: "vanilla-custard", name: "Caramel Custard", palette: ["#FFF2CC", "#FFE8A3", "#F4EFE9"], bottle: { from: "#FFF8E6", to: "#FFF2CC" }, notes: ["vanilla bean", "custard", "soft"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFF9EC 100%)" },
