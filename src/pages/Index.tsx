...
const FLAVORS = [
  ...
  { key: "strawberry-jam", name: "Creamy Rainbow Candy", palette: ["#FFD6D6", "#FFE8A3", "#CFE8FF"], bottle: { from: "#FFF1F1", to: "#FFD6D6" }, notes: ["rainbow swirl", "creamy sweet", "candy burst"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFF1F1 100%)" },
