...
const FLAVORS = [
  ...
  { key: "peach-ice", name: "Peach Ice", image: "/lovable-uploads/a7e1f996-6b3d-4c45-875c-54ec99c2ec49.png", palette: ["#FFCFA3", "#FFE8A3", "#CFE8FF"], bottle: { from: "#FFF1E6", to: "#FFCFA3" }, notes: ["peach", "iced", "gentle sweet"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFF4E9 100%)" },
