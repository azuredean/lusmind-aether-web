...
const FLAVORS = [
  ...
  { key: "tobacco-mint", name: "Creamy Rainbow Candy", image: "/lovable-uploads/3ce25664-49eb-4c06-b7e4-fd8609332e17.png", palette: ["#D2B48C", "#D8F3E1", "#F4EFE9"], bottle: { from: "#F1E8D2", to: "#D2B48C" }, notes: ["tobacco base", "mint lift", "balanced"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #F2EBDD 100%)" },
