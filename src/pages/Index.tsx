...
const FLAVORS = [
  ...
  { key: "tobacco-mint", name: "Tobacco & Nut", palette: ["#D2B48C", "#D8F3E1", "#F4EFE9"], bottle: { from: "#F1E8D2", to: "#D2B48C" }, notes: ["tobacco base", "mint lift", "balanced"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #F2EBDD 100%)" },
