...
const FLAVORS = [
  ...
  { key: "arctic-berry-ice", name: "Arctic Sweet Ice", palette: ["#CFE8FF", "#E5D9FF", "#D8F3E1"], bottle: { from: "#F0F7FF", to: "#CFE8FF" }, notes: ["berry", "icy", "clean"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #EEF8FF 100%)" },
