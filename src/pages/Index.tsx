...
const FLAVORS = [
  ...
  { key: "green-coconut", name: "Green Coconut", palette: ["#D8F3E1", "#EAF9F1", "#CFE8FF"], bottle: { from: "#F0FFF4", to: "#D8F3E1" }, notes: ["coconut", "tropical", "creamy"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #F0FFF2 100%)" },
