...
const FLAVORS = [
  ...
  { key: "monster-drink", name: "Monster Drink", image: "/lovable-uploads/91c3186a-70e4-42e6-bf1e-406deac7ce00.png", palette: ["#E6FE7F", "#CFE8FF", "#FFE8A3"], bottle: { from: "#F2FFE6", to: "#E6FE7F" }, notes: ["energy note", "citrus hint", "sparkling feel"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #F5FFE6 100%)" },
  { key: "banana-nut", name: "Banana Nut", image: "/lovable-uploads/a464032b-a094-456e-aea8-80e539a970c7.png", palette: ["#FFE8A3", "#F4EFE9", "#D7C2A3"], bottle: { from: "#FFF8E1", to: "#FFE8A3" }, notes: ["ripe banana", "nutty body", "soft sweet"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFF7E9 100%)" },
  { key: "keel-scout", name: "Double Apple Shisha", image: "/lovable-uploads/0437b888-5834-4830-9e2c-7f144ebc2572.png", palette: ["#CFE8FF", "#E6FE7F", "#D8F3E1"], bottle: { from: "#EAF4FF", to: "#CFE8FF" }, notes: ["double apple", "shisha smooth", "rich"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #EEF6FF 100%)" },
  { key: "tobacco-mint", name: "Tobacco & Nut", image: "/lovable-uploads/3ce25664-49eb-4c06-b7e4-fd8609332e17.png", palette: ["#D2B48C", "#D8F3E1", "#F4EFE9"], bottle: { from: "#F1E8D2", to: "#D2B48C" }, notes: ["tobacco base", "nutty body", "balanced"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #F2EBDD 100%)" },
  { key: "strawberry-jam", name: "Creamy Rainbow Candy", image: "/lovable-uploads/407f84ee-9002-4f3c-93f9-934ad61b36df.png", palette: ["#FFD6D6", "#FFE8A3", "#CFE8FF"], bottle: { from: "#FFF1F1", to: "#FFD6D6" }, notes: ["rainbow swirl", "creamy sweet", "candy burst"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFF1F1 100%)" },
  { key: "kiwi-passion-fruit", name: "Kiwi & Passion Fruit", image: "/lovable-uploads/58d2fae3-6db0-472a-9ad3-63efa0fe4eba.png", palette: ["#D8F3E1", "#FFE8A3", "#FFCFA3"], bottle: { from: "#E6F9D8", to: "#FFF0CC" }, notes: ["kiwi", "tropical", "bright"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #F3FFE9 100%)" },
  { key: "cinnamon-apple-pie", name: "Cinnamon Apple Pie", image: "/lovable-uploads/74d4636a-0a38-40e9-af35-cbce508310fb.png", palette: ["#FFD6B5", "#FFE8A3", "#D2B48C"], bottle: { from: "#FFF0E3", to: "#FFD6B5" }, notes: ["cinnamon", "baked apple", "buttery"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFF0E6 100%)" },
  { key: "peach-ice", name: "Peach Ice", image: "/lovable-uploads/f2771975-4d08-4667-84d2-768cc835b7c4.png", palette: ["#FFCFA3", "#FFE8A3", "#CFE8FF"], bottle: { from: "#FFF1E6", to: "#FFCFA3" }, notes: ["peach", "iced", "gentle sweet"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFF4E9 100%)" },
  { key: "coffee-tobacco", name: "Coffee Tobacco", image: "/lovable-uploads/5018366c-93d6-45d8-9b6c-3a38dd9f4f73.png", palette: ["#C8B18B", "#F4EFE9", "#D2B48C"], bottle: { from: "#EDE3D2", to: "#C8B18B" }, notes: ["roasted", "tobacco warmth", "rounded"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #F1EAE0 100%)" },
  { key: "blueberry-raspberry", name: "Blueberry Raspberry", image: "/lovable-uploads/bc1fc5de-0472-4e0b-99df-56017a874103.png", palette: ["#CFE8FF", "#E5D9FF", "#FFD6D6"], bottle: { from: "#EEF5FF", to: "#CFE8FF" }, notes: ["blueberry", "raspberry", "silky"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #EEF3FF 100%)" },
  { key: "vanilla-custard", name: "Caramel Custard", image: "/lovable-uploads/577fbebc-68bb-4093-ab17-308fae3d01e0.png", palette: ["#FFF2CC", "#FFE8A3", "#F4EFE9"], bottle: { from: "#FFF8E6", to: "#FFF2CC" }, notes: ["vanilla bean", "custard", "soft"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFF9EC 100%)" },
  { key: "mango-ice", name: "Mango Ice", image: "/lovable-uploads/822f2f7d-7d53-4e3d-ae1d-58cd9bde0e71.png", palette: ["#FFCFA3", "#FFE8A3", "#CFE8FF"], bottle: { from: "#FFF0E0", to: "#FFCFA3" }, notes: ["mango", "iced", "bright"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFF5E8 100%)" },
  { key: "pineapple-coconut-ice", name: "Pineapple Coconut Ice", image: "/lovable-uploads/175a9edd-1618-4c0e-9274-bd02344d1215.png", palette: ["#FFF2CC", "#EAF9F1", "#CFE8FF"], bottle: { from: "#FFFFE8", to: "#FFF2CC" }, notes: ["pineapple", "coconut", "cool"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFFFF0 100%)" },
  { key: "niagara-grape", name: "Niagara Grape", image: "/lovable-uploads/e038dd85-abb1-4f83-a740-67ad5ddd3e05.png", palette: ["#E5D9FF", "#CFE8FF", "#FFD6D6"], bottle: { from: "#F3ECFF", to: "#E5D9FF" }, notes: ["grape", "juicy", "smooth"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #F7F2FF 100%)" },
  { key: "green-apple", name: "Green Apple", image: "/lovable-uploads/abbd21c8-208e-4b40-97f2-9255fea9c770.png", palette: ["#E6FE7F", "#D8F3E1", "#CFE8FF"], bottle: { from: "#F2FFE6", to: "#E6FE7F" }, notes: ["crisp", "tart", "refreshing"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #F5FFE8 100%)" },
  { key: "orange-soda", name: "Orange Soda", image: "/lovable-uploads/8e9f2418-eb1b-4b3c-ae84-cff7bb4703d4.png", palette: ["#FFD1A3", "#FFE8A3", "#CFE8FF"], bottle: { from: "#FFF2E6", to: "#FFD1A3" }, notes: ["orange", "sparkling", "bright"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFF1E9 100%)" },
  { key: "strawberry-cake", name: "Strawberry Cake", image: "/lovable-uploads/348c3797-7f4a-4d95-a936-43dee5f6960e.png", palette: ["#FFD6D6", "#E5D9FF", "#CFE8FF"], bottle: { from: "#FFF3F3", to: "#FFD6D6" }, notes: ["strawberry", "cake", "sweet"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFF6FD 100%)" },
  { key: "green-coconut", name: "Green Coconut", image: "/lovable-uploads/4368fcfa-8df8-410d-89de-dd898164b244.png", palette: ["#D8F3E1", "#EAF9F1", "#CFE8FF"], bottle: { from: "#F0FFF4", to: "#D8F3E1" }, notes: ["coconut", "tropical", "creamy"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #F0FFF2 100%)" },
  { key: "arctic-berry-ice", name: "Arctic Sweet Ice", image: "/lovable-uploads/5a603468-2ecb-409f-9820-41d985294da4.png", palette: ["#CFE8FF", "#E5D9FF", "#D8F3E1"], bottle: { from: "#F0F7FF", to: "#CFE8FF" }, notes: ["cool", "icy", "clean"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #EEF8FF 100%)" },
  ...
  { key: "cool-yuzu-cedar", name: "Cool Yuzu Cedar", image: "/lovable-uploads/1a057b10-b648-4b7f-9860-481b721fcef3.png", palette: ["#D8F3E1", "#FFF2CC", "#D2B48C"], bottle: { from: "#F0FFF4", to: "#D8F3E1" }, notes: ["yuzu citrus", "cedar wood", "cooling finish"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #F0FFF2 100%)" },
] as const;
