...
const FLAVORS = [
  ...
  { key: "strawberry-cake", name: "Strawberry Cake", palette: ["#FFD6D6", "#E5D9FF", "#CFE8FF"], bottle: { from: "#FFF3F3", to: "#FFD6D6" }, notes: ["strawberry", "cake", "sweet"], bgTint: "linear-gradient(180deg, #F7F5F2 0%, #FFF6FD 100%)" },
