...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-10 left-0 right-0 z-50 flex justify-center px-4 md:px-6">
      <div 
        className={`w-full max-w-7xl transition-all duration-300 rounded-full h-10 flex items-center justify-between px-4 ${
          scrolled 
            ? "bg-[rgba(43,48,59,0.05)] backdrop-blur-lg border border-[rgba(43,48,59,0.1)] shadow-lg" 
            : "bg-[rgba(43,48,59,0.02)] backdrop-blur-md border border-[rgba(43,48,59,0.05)]"
        }`}
      >
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <a href="#blog" className="text-sm font-normal hover:text-accent transition-colors">
            Blog
          </a>
      ...
      {/* Mobile menu */}
      {mobileMenuOpen && (
        <div className="absolute top-12 left-4 right-4 md:hidden bg-background/95 backdrop-blur-lg border border-border rounded-2xl p-4 shadow-lg animate-fade-in-up">
